...
module m_boundary_common
    ...
    private; public :: s_initialize_boundary_common_module, s_populate_variables_buffers, s_create_mpi_types, &
        ...
        & s_read_serial_boundary_condition_files, s_read_parallel_boundary_condition_files, s_assign_default_bc_type, &
        & s_populate_grid_variables_buffers, s_finalize_boundary_common_module
